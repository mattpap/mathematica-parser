...
class MathematicaParser extends RegexParsers with PackratParsers {
    ...
    lazy val expr: PackratParser[Expr] =
        ...
        compound  | // infix, flat
        assign    | // infix, right group
        replace   | // infix, left group
        rule      | // infix, right group
        or        | // infix, flat
        and       | // infix, flat
        not       | // prefix
        same      | // infix, flat
    ...
    lazy val compoundExpr: PackratParser[Expr] =
        assign | replace | rule | or | and | not | same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val assignExpr: PackratParser[Expr] =
        replace | rule | or | and | not | same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val replaceExpr: PackratParser[Expr] =
        rule | or | and | not | same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val ruleExpr: PackratParser[Expr] =
        or | and | not | same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val orExpr: PackratParser[Expr] =
        and | not | same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val andExpr: PackratParser[Expr] =
        not | same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest

    lazy val not: PackratParser[Expr] = "!" ~ (not | notExpr) ^^ {
        case _ ~ expr => Builtins.Not(expr)
    }
    lazy val notExpr: PackratParser[Expr] =
        same | cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val sameExpr: PackratParser[Expr] =
        cmp | span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val cmpExpr: PackratParser[Expr] =
        span | add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val spanExpr: PackratParser[Expr] = add | mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val addExpr: PackratParser[Expr] =
        mul | exp | neg | factorial | part | test | tightest
    ...
    lazy val mulImpliedRhsExpr: PackratParser[Expr] =
        not | exp | factorial | part | test | tightest
    lazy val mulExpr: PackratParser[Expr] =
        not | exp | neg | factorial | part | test | tightest

    lazy val exp: PackratParser[Expr] = expLhsExpr ~ "^" ~ (exp | expRhsExpr) ^^ {
        case lhs ~ _ ~ rhs => Builtins.Power(lhs, rhs)
    }
    lazy val expLhsExpr: PackratParser[Expr] = factorial | part | test | tightest
